...
from RishuUserBot import CMD_HELP, StartTime, app
from RishuUserBot.helper.data import Data
from RishuUserBot.helper.inline import inline_wrapper, paginate_help
...
<b> • 𝗕𝗔𝗗𝗡𝗔𝗠 :</b> {message.from_user.mention}
