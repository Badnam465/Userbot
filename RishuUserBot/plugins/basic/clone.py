...
from RishuUserBot.helper.basic import edit_or_reply, get_text, get_user

from RishuUserBot.plugins.help import *

OWNER = os.environ.get("OWNER", "B A D N A M")
BIO = os.environ.get("BIO", "ɪ ᴀᴍ ᴘᴀʀᴛ ᴏғ @lllll_BADNAM_BABY_lllll")
